...
# date_cname1 = date_csv1.fieldnames   # 讀進來的 type(data) 都是str
#
# time_TSMC = []
# time_foxconn = []
# time_uni = []
# for aline in date_csv1:  # 台積電,Foxconn, Uni，三家公司依據column去做比對，1900/1/0是excel自動把0輸出成日期的樣子
...
#  這個東西就是ASCI code裡面在使用openxlrx的時候會出現的character error，要把他排除掉
illegal_character = re.compile(r'[\000-\010]|[\013-\014]|[\016-\037]')

# 用迴圈檢視日期跟關鍵字分別有沒有在date和content的字串裡
for aline in csv1:
...
# 建立一個表格資料，然後.to_excel輸出成excel的形式
